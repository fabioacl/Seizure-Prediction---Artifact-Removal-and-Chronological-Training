...
model_type = 'Base Model Chronological'
...
for patient_index in range(number_patients):
    ...
    for run_index in range(0,31):
        ...
        for train_index in range(num_testing_seizures):
            ...
            training_data,training_labels,training_datetimes = utils.get_training_dataset(dataset, dataset_labels,
            ...
            np.save(f'{model_type}/Patient {patient_number}/standardisation_values_{patient_number}_{run_index}_{test_index}',norm_values)
            ...
            model_checkpoint_cb = ModelCheckpoint(f'{model_type}/Patient {patient_number}/seizure_prediction_model_{patient_number}_{run_index}_{test_index}.h5',
            ...
            # Load best weights
            model.load_weights(f'{model_type}/Patient {patient_number}/seizure_prediction_model_{patient_number}_{run_index}_{test_index}.h5')
        ...
        save_filepath = 'Write here save filepath'
        utils.save_results_array(save_filepath,all_sensitivities,all_fpr_h,all_fp_values,all_alarms,
                                 all_pred_labels,all_true_labels,all_datetimes,all_last_epochs,
        ...
        utils.save_results_csv(patient_number,f'{model_type}/results_{patient_number}_{model_type}.csv',all_sensitivities,
                               all_fpr_h,sop,test_seizures,avg_last_epoch)
