...
# -*- coding: utf-8 -*-
"""
Created on Thu May  5 17:15:08 2022
...
sop_times = [50,30,20,20,20,50,50,30,30,20,
             20,50,20,30,50,30,30,40,50,10,
             30,10,50,10,50,50,50,50,50,50,
             50,40,40,20,50,20,30,50,50,30,
             40]
sop_times = [30]*41
...
model_type = 'Only Features Not Processed'

for patient_index in range(38,39):
    ...
    if training_seizures == num_seizures:
        continue
    ...
    for run_index in range(0,31):
        ...
        model_checkpoint_cb = ModelCheckpoint(f'{model_type}/Patient {patient_number}/seizure_prediction_model_{patient_number}_{run_index}.h5', 'val_loss', save_best_only=True, verbose=1, mode='min')
        ...
        save_results(patient_number,f'{model_type}/results_{patient_number}_{model_type}.csv',all_sensitivities,all_fpr_h,sop,test_seizures,avg_last_epoch)
        # Clear variables
