...
# -*- coding: utf-8 -*-
"""
Created on Sat May 03 09:41:52 2022
...
def validate_architecture(dataset,datetimes,model_type,seizure_onset_datetimes,training_time,training_ratio,sop,sph,patient_number,batch_size,train_epochs,nr_features=32):
    ...
    dataset,dataset_labels,datetimes,seizure_onset_datetimes = remove_datasets_with_small_preictal(dataset,dataset_labels,datetimes,seizure_onset_datetimes,
                                                                                                   sop,sph,window_seconds,fp_threshold,training_seizures,decay_flag)
    ...
    feature_norm_values = [np.mean(X_feat_train,axis=0),np.std(X_feat_train,axis=0)]
    norm_values = feature_norm_values
