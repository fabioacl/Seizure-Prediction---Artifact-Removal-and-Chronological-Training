...
for patient_index in range(0,41):
    ...
    # with open(f"/mnt/6a3bf9e0-7462-43d9-b6ae-3aa1a8be2f6a/fabioacl/Fabio/Fabio_Task_3/Epileptic-Seizure-Prediction/Seizure Prediction/Test Datasets Not Processed/pat_{patient_number}.pkl", "wb") as f:
    #     pickle.dump(test_dataset,f,protocol=4)
    # np.save(f"/mnt/6a3bf9e0-7462-43d9-b6ae-3aa1a8be2f6a/fabioacl/Fabio/Fabio_Task_3/Epileptic-Seizure-Prediction/Seizure Prediction/Test Datasets/pat_{patient_number}.npy",test_dataset)
    # continue
    ...
    for run_index in range(0,31):
        ...
        save_results(patient_number,f'{model_type}/results_{patient_number}_{model_type}.csv',all_sensitivities,all_fpr_h,sop,test_seizures,last_epoch)
        # Clear variables
